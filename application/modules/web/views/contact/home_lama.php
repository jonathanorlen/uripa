	            ...
	            <tbody>               
	                ...
	                <tr>
	                	<td style="width:600px;">
							...
							?>
							<div class="card">
								<span class="contact-line c1" style="padding:10px 25px;display:block;color:#808285;border-bottom:1px dotted #c5bcbc"><img src="<?php echo base_url() . 'component/web/images/c1.png '?>" alt="Logo">&nbsp;&nbsp;&nbsp;<?php echo $hasil_get->isi;?></span>
							</div>
	                	</td>
	                </tr>
	                <tr>
