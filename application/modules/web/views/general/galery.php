    ...
    <body id="home" class="homepage">
    	<header id="header">
    		<nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner" style="background-color:white; opacity: 1  ; height : 80px;">
                ...
                <li class="scroll active"><a href="<?php echo base_url().'#portofolio'?>" style="font-weight: bold;font-family: arial;font-size: 18px;color: #b245d6;">Our Gallery</a></li>
        ...
        <section id="portfolio" style="background-color: white;margin-top:-40px">
          <div class="container">
