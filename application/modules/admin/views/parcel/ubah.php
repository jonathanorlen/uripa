...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/parcel/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
			success : function(data) {  
				$(".sukses").html(data);   
				setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'admin/parcel/daftar' ?>";},1500);              
			},  
			error : function() {  
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Edit parcel</h3>
						<!-- tools box -->
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM parcel where id='$id'");
						$hasil = $get->row();
						?>
						...
						<form method="post" id="data_form">
							...
							<div>
								<textarea name="isi_parcel" class="textarea" placeholder="Konten Product" style="width: 100%; height: 255px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
									<?php echo $hasil->isi; ?>
								</textarea>
							</div>
