				...
				<div class="box box-info">
					...
					<div class="box-body">            
						...
						<form method="post" id="data_form">
							...
							<div class="form-group">
								<label>Tanggal</label>
								<input type="date" class="date-picker form-control" data-date-format="yyyy-mm-dd" name="tgl" value="<?php echo $hasil->tgl; ?>" />
							</div>
							<div>
								<textarea name="isi" class="textarea" placeholder="Konten Event" style="width: 100%; height: 255px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
									<?php echo $hasil->isi; ?>
								</textarea>
							</div>
