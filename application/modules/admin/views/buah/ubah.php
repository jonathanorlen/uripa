...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/buah/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Edit buah</h3>
						<!-- tools box -->
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM buah where id='$id'");
						$hasil = $get->row();
						?>
						...
						<form method="post" id="data_form">
							...
							<div>
								<textarea name="isi_buah" class="textarea" placeholder="Deskripsi Buah" style="width: 100%; height: 255px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
									<?php echo $hasil->isi; ?>
								</textarea>
							</div>
