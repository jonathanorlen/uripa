          ...
          <div >
            <div class="konten" style="padding: 20px;">
                <div style="margin-left:10px">
                    <h1 style="font-size: 1.5em;font-weight: bold;" ><?php echo $hasil->judul; ?></h1>
                    <p  font-size: 13px;"><?php echo TanggalIndo($hasil->tanggal); ?></p> 
                </div>
                ...
                <center>
                    <div style="width:50%;
                    height: 400px;
                    background-image: url('<?php echo base_url() . 'component/upload/foto/uploads/'.$name_img; ?>');
                    background-repeat: no-repeat;
                    background-size: contain;">
                </div>
            </center>
            <center>
                <div style="width:80%;height:auto;background-repeat: no-repeat;
                background-size: contain;">
                <?php echo $hasil->isi;  ?>
            </div>
        </center>
