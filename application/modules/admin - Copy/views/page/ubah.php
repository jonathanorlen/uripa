...
$(function () {
	...
	$("#data_form").submit( function() {    
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'admin/page/simpan_ubah' ?>",  
			cache :false,  
			data :$(this).serialize(),
					...
					<div class="box-body">            
						...
						<form method="post" id="data_form">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nama_page" value="<?php echo $hasil->nama_page; ?>" />
							</div>                        
							<div>
								<textarea name="isi_page" class="textarea" placeholder="Message" style="width: 100%; height: 255px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
