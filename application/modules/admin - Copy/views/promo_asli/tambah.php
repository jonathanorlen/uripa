<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/promo/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
        ...
        <div class="box box-info">
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
			  ...
			  <div class="form-group">
                <label>Tanggal </label>
                <input  type="date" class="date-picker form-control" data-date-format="yyyy-mm-dd" name="tgl" placeholder="Tanggal" />
              </div>
			  <div>
				<label>Isi promo</label>
                <textarea name="isi" class="textarea" placeholder="Konten Event" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
