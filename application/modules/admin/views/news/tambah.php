...
<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/news/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              ...
              <div>
                ...
                <textarea name="isi_berita" class="textarea" placeholder="Konten Berita" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
