...
<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/parcel/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              ...
              <div>
                ...
                <textarea name="isi" class="textarea" placeholder="Konten Service" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
			  <div class="box-footer clearfix">
				  <label>Upload Foto</label>
                  <a class="btn btn-app blue" id="upload_foto">
                  <i class="fa fa-edit"></i> Image Service
                  </a>
              </div>
