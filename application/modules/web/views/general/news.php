             ...
             <div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms" >
              <article  >
               <header class="entry-header"  >
                 <div class="entry-thumbnail" style="width: auto;height: auto; margin-bottom: 20px; margin-top: 20px;">
                 ...
                 <!-- <img style="width: 100%; height: 200px; position: relative ;  " class="img-responsive" src="<?php echo
