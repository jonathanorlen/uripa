    			...
    			<div class="container">
    				...
    				<div class="collapse navbar-collapse navbar-right">
    					<ul class="nav navbar-nav">
    						...
    						<li class="scroll active"><a href="<?php echo base_url().'#blog'?>" style="font-weight: bold;font-family: arial;font-size: 18px;color: #b245d6;">Our Services</a></li>
           ...
           foreach ($hasil_get as $item) {
            ...
            <div class="col-sm-4" >
              ...
              <article  >
               <header class="entry-header">
                ...
                <div style="background:url('<?php echo base_url() . 'component/upload/foto/uploads/' . $name_img; ?>');
                 ...
                 <!-- <img style="width: 100%; height: 250px;" class="img-responsive" src="<?php echo
             ...
             <div class="entry-content">
              <p style="background:rgba(255, 255, 255, 0.88);display:inline-block; position:relative; top:-38px; width:340px; padding:5px; color:#696767;font-weight: bold;"><?php echo substr($item['judul'],0,35);?>
              </p>
              <a class="btn btn-primary" style="background-color:purple;border-color:#f9e6ff;" href="<?php echo base_url() . 'web/detail_our_service/' . $item['id'] ?>">Read More</a>
            </div>
          </article>
        </div>
      </div>
