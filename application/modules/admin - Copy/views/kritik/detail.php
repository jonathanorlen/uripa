			...
			<section class="col-lg-12 connectedSortable">
				...
				<div class="box box-info">
					<div class="box-header">
						...
						<h3 class="box-title">Detail Kritik & Saran</h3>
						<!-- tools box -->
					...
					<div class="box-body">            
						...
						$get = $this->db->query("SELECT * FROM kritik where id = '$id'");
						$hasil = $get->row();
						?>
						...
						<form method="post" id="data_form">
                            ...
                            <label>ID Pelanggan</label>
                                <input type="text" class="form-control" name="id_pelanggan" value="<?php echo $hasil->id_pelanggan; ?>" readonly />	
							</div> 
							<div class="form-group">
                            <label>Nama</label>
                            ...
                            <input type="text" class="form-control" name="subject" value="<?php echo $hasil->bidang; ?>" readonly /></div> 
                            ...
                            <div class="form-group">
                            <label>Tanggal</label>
                            <input type="text" class="form-control" name="bagaimana" value="<?php echo tanggalindo($hasil->date); ?>" readonly />	
                            </div>
						</form>
					</div>
				</div>
