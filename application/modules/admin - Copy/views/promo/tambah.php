          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
			  ...
			  <div>
                ...
                <textarea name="isi_event" class="textarea" placeholder="Konten Event" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
