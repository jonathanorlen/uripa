		...
		<div class="konten">
				<h1>Our Promo Today</h1>
				 <?php     
					...
					$get = $this->db->query("SELECT * FROM slider where status='1'");
				...
				<ul class="section">
					<li>
						...
						<div>
							<h2 >
                            <a href="<?php echo base_url() . 'web/detail_slider/'.$item['id'] ?>"><?php echo $item['judul'];?>
								</a>
							</h2>          
							<p><?php echo substr($item['isi'],0,300); ?> ... 
					<a  href="<?php echo base_url() . 'web/detail_slider/'.$item['id'] ?>" class="more">Readmore<span> </span></a>
		    		</p>
